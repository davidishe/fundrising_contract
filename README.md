...
В случае необходимости для отправки токенов в целях тестирования "refund" разработана простой веб-сервис, который отправляет токены с полезной нагрузкой в пейлоаде. Как формируется пейлоад можно уточнить в личке.
https://terraplatform.space/dashboard/purchase

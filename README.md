...
- можно отправить токены обратно на контракт и вернуть TON по тому курсу sellRate, за который эти токены были выданы, за вычетом комиссии на gas (const)
5. Значение "claimStart" больше чем fundrisingDeadline например на 2 недели
6. До наступления fundrisingDeadline владелец контракта не может получить деньги
